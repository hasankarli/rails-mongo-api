class ApplicationController < ActionController::API
    ...
    def check_token(user_type = 1, return_user = false)
        ...
        if user_token
            ...
            if account.type.to_i != user_type
                render json: { msg: 'Unauthorized Your Type Not 1' }, status: :unauthorized
                return false
            end
                if account
            ...
            render json: { msg: 'Unauthorized Token Unacceptable or Token Empty' }, status: :unauthorized    
        end
    end
